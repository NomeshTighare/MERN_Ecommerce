...
router.post("/add-product", upload.any("pImages"), productController.postAddProduct);
router.post("/edit-product", upload.any("pImages"), productController.postEditProduct);
