...
router.post("/add-product", upload.array("pImages"), productController.postAddProduct);
router.post("/edit-product", upload.array("pImages"), productController.postEditProduct);
